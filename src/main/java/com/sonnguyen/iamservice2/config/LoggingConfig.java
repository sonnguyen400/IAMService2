...
public class LoggingConfig {
    ...
    public void endpointBefore(JoinPoint p) {
        ...
        log.info("ip {} agent {} path: {} user {}", request.getRemoteAddr(),request.getHeader("User-Agent"),request.getServletPath(), SecurityContextHolder.getContext().getAuthentication().getPrincipal());
        try {
